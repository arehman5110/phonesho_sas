            ...
            <div>
                ...
                <select name="type"
                        ...
                        class="w-full px-3.5 py-2.5
                               ...
                               cursor-pointer">
                    <option value="fixed"
                            {{ old('type', $voucher?->type) === 'fixed'
                                ? 'selected' : '' }}>
                        💷 Fixed Amount (£)
                    </option>
                    <option value="percentage"
                            {{ old('type', $voucher?->type) === 'percentage'
                                ? 'selected' : '' }}>
                        % Percentage
                    </option>
                </select>
                ...
                <select name="assigned_to"
                    ...
                    @foreach($customers as $customer)
                        <option value="{{ $customer->id }}"
                                {{ old('assigned_to', $voucher?->assigned_to)
        ...
        <div>
            ...
            <textarea name="notes"
                      ...
                      class="w-full px-3.5 py-2.5 resize-none
                             ...
                             bg-gray-50 dark:bg-gray-800
                             text-gray-900 dark:text-white
                             focus:border-indigo-500 transition-all">{{ old('notes', $voucher?->notes) }}</textarea>
        </div>
        ...
        <div class="flex items-center justify-between py-2">
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                ...
                <input type="checkbox"
                       ...
                       value="1"
                       class="sr-only peer"
                       {{ old('is_active', $voucher?->is_active ?? true)
                           ? 'checked' : '' }}>
