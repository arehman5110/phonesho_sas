...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4">
    ...
    <div onclick="ProductIndex.filterByStock('low')"
        ...
        <div>
            ...
            <p class="text-2xl font-black text-amber-600 dark:text-amber-400">{{ $stats['low'] }}</p>
        </div>
    </div>
    ...
    <div onclick="ProductIndex.filterByStock('out')"
        ...
        <div>
            ...
            <p class="text-2xl font-black text-red-500 dark:text-red-400">{{ $stats['out'] }}</p>
        </div>
    </div>

</div>

{{-- ── Filters (AJAX — no submit button) ──────── --}}
<div class="bg-white dark:bg-gray-900
    ...
    {{-- Hidden stock filter value --}}
    <input type="hidden" id="filter-stock" value="{{ request('stock_filter', '') }}">
</div>
...
{{-- Table wrapper (relative for loading overlay) --}}
<div class="relative">
    ...
    <div class="bg-white dark:bg-gray-900
        ...
        <div id="products-pagination" class="{{ $products->hasPages() ? '' : 'hidden' }}
                                              px-5 py-4 border-t
