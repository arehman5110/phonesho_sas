...
<div class="device-card bg-white dark:bg-gray-900
    ...
    <div class="p-5 space-y-4">
        ...
        {{-- ── Row 1: Device Name | Device Type | Status ── --}}
                ...
                <select name="devices[__INDEX__][device_type_id]"
                    ...
                    @foreach($deviceTypes as $type)
                        <option value="{{ $type->id }}"
                                {{ $type->name === 'Mobile Phone' ? 'selected' : '' }}>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
                ...
                {{-- Hidden warranty_status driven by days --}}
                <input type="hidden"
        ...
        <div>
            ...
            <div x-data="PartsInput('devices[__INDEX__][issues]', {
                             searchUrl    : null,
                             suggestions  : {{ json_encode($issueSuggestions ?? []) }},
        ...
        <div>
            ...
            <div x-data="PartsInput('devices[__INDEX__][repair_type_tags]', {
                             searchUrl    : null,
                             suggestions  : {{ json_encode($repairTypes->pluck('name')->toArray() ?? []) }},
                ...
                {{-- Hidden inputs for multiple repair types --}}
                <template x-for="(tag, i) in parts"
                          :key="'rt-hidden-' + i">
                    <input type="hidden"
        ...
        {{-- ── Row 5: Parts Used + Price (same line) ───── --}}
