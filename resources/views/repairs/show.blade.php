        ...
        <div class="px-6 py-5 space-y-4">
            ...
            <div>
                ...
                <input type="text" id="email-subject"
                       value="Repair Receipt — {{ $repair->reference }}"
            ...
            <div>
                ...
                <textarea id="email-message" rows="4"
                          ...
                          class="w-full px-3.5 py-2.5 border border-gray-200 dark:border-gray-700
                                 ...
                                 text-gray-900 dark:text-white placeholder-gray-400
                                 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10
                                 focus:bg-white dark:focus:bg-gray-900 transition-all resize-none">{{ "Dear " . ($repair->customer?->name ?? 'Customer') . ",
...
// ── Email Receipt Modal ───────────────────────────────────────
const _EMAIL_URL = '{{ route("repairs.email-receipt", $repair) }}';
