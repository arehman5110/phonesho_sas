...
<head>
    ...
    <title>Repair Receipt — {{ $repair->reference }}</title>
...
<div class="receipt" id="receipt">
    ...
    <div class="receipt-header">
        ...
        <div class="shop-meta">
            ...
            @if($repair->shop->phone)
                Tel: {{ $repair->shop->phone }}<br>
            @endif
            @if($repair->shop->email)
                {{ $repair->shop->email }}<br>
            @endif
    ...
    <div style="margin-bottom:12px;">
        <div class="info-row">
            ...
            <span class="value">{{ $repair->reference }}</span>
        </div>
        <div class="info-row">
        ...
        <div class="info-row">
            ...
            <span class="value">{{ $repair->status->name }}</span>
        </div>
        @endif
        <div class="info-row">
            <span class="label">Served by</span>
            <span class="value">
                {{ $repair->createdBy?->name ?? 'Staff' }}
            </span>
        </div>
        @if($repair->assignedTo)
        <div class="info-row">
            <span class="label">Assigned to</span>
            <span class="value">{{ $repair->assignedTo->name }}</span>
        </div>
        @endif
        <div class="info-row">
            <span class="label">Delivery</span>
            <span class="value">{{ $repair->delivery_type_label }}</span>
        </div>
    </div>
    ...
    <div style="margin-bottom:12px;">
        ...
        <div class="device-card">
            ...
            <div class="device-field">
                ...
                <span class="field-value">{{ $device->repair_type }}</span>
            </div>
            @endif
            ...
            <div class="device-price">
                <span>Price</span>
                <span>£{{ number_format($device->price, 2) }}</span>
            </div>
    ...
    <div style="margin-bottom:12px;">
        ...
        <div class="grand-total">
            <span>TOTAL</span>
            <span>£{{ number_format($repair->final_price, 2) }}</span>
        </div>
    </div>
    ...
    <div class="receipt-footer">
        ...
        <p>{{ $settings['repair_warranty'] }}</p>
        @endif

        @if(!empty($settings['repair_terms']))
        <p style="margin-top:4px;">{{ $settings['repair_terms'] }}</p>
        @endif
...
<div class="receipt-actions">
    ...
    <button class="btn btn-email"
            id="emailBtn"
            onclick="sendReceiptEmail({{ $repair->id }})">
        ✉ Email
    </button>
    @endif
