...
<?php $component->withAttributes([]); ?>
 <?php $__env->slot('title', null, []); ?> Add Shop <?php $__env->endSlot(); ?>

<?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Add New Shop','subtitle' => 'Fill in the details to create a new shop','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Add New Shop','subtitle' => 'Fill in the details to create a new shop','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Dashboard', 'route' => 'dashboard'],
        ['label' => 'Shops',     'route' => 'shops.index'],
        ['label' => 'Add Shop'],
    ])]); ?>
...
<?php $component->withAttributes(['title' => 'Shop Details','color' => 'indigo']); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="country" value="<?php echo e(old('country', 'United Kingdom')); ?>"
...
<?php $component->withAttributes(['title' => 'Currency & Timezone','color' => 'emerald']); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="currency" value="<?php echo e(old('currency', 'GBP')); ?>"
                           placeholder="GBP"
                           class="w-full px-3.5 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl
                                  text-sm outline-none bg-gray-50 dark:bg-gray-800
                                  text-gray-900 dark:text-white
                ...
                <div>
                    ...
                    <input type="text" name="currency_symbol" value="<?php echo e(old('currency_symbol', '£')); ?>"
                           placeholder="£"
                           class="w-full px-3.5 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl
                                  text-sm outline-none bg-gray-50 dark:bg-gray-800
                                  text-gray-900 dark:text-white
                ...
                <div>
                    ...
                    <select name="timezone"
                        ...
                        <option value="<?php echo e($tz); ?>" <?php echo e(old('timezone','Europe/London') === $tz ? 'selected' : ''); ?>>
                            <?php echo e($tz); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Your Tech Point\Desktop\Shop\phonesho_sas\resources\views/shops/create.blade.php ENDPATH**/ ?>