                ...
                <div class="flex items-center gap-3 px-5 py-3.5 border-b border-gray-200 dark:border-gray-700"
                    ...
                    <div x-show="mode==='sell'" class="flex-1 mx-2" style="display:none;">
                        <select :id="'inv-'+dev.id"
                            ...
                            <?php $__currentLoopData = $stockDevices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sd->id); ?>"
                                    data-device="<?php echo e(str_replace("'","&#39;",json_encode([
                                        'id'            => $sd->id,
                                ...
                                <?php echo e($sd->model_name); ?><?php echo e($sd->brand ? ' — '.$sd->brand->name : ''); ?><?php echo e($sd->storage ? ' · '.$sd->storage : ''); ?> · £<?php echo e(number_format($sd->purchase_price,2)); ?> cost
                            </option>
        ...
        async submit() {
            ...
            try {
                const url  = this.mode==='sell'
                    ? (this.sellDeviceId ? `<?php echo e(url('buy-sell')); ?>/${this.sellDeviceId}/sell` : '<?php echo e(route("buy-sell.buy")); ?>')
                    : '<?php echo e(route("buy-sell.buy")); ?>';
