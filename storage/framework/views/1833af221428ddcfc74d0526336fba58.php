...
<?php $component->withAttributes([]); ?>
 <?php $__env->slot('title', null, []); ?> Edit <?php echo e($repair->reference); ?> <?php $__env->endSlot(); ?>
...
<form id="repairForm" method="POST"
      action="<?php echo e(route('repairs.update', $repair)); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Edit '.e($repair->reference).'','subtitle' => 'Update all repair details','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit '.e($repair->reference).'','subtitle' => 'Update all repair details','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Dashboard', 'route' => 'dashboard'],
        ['label' => 'Repairs',   'route' => 'repairs.index'],
        ['label' => $repair->reference, 'route' => 'repairs.show', 'params' => $repair],
        ['label' => 'Edit'],
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="book_in_date"
                           value="<?php echo e($repair->book_in_date?->format('Y-m-d')); ?>"
                           class="repair-input">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="completion_date"
                           value="<?php echo e($repair->completion_date?->format('Y-m-d')); ?>"
                           class="repair-input">
                </div>
                ...
                <div>
                    ...
                    <select name="delivery_type" class="repair-input">
                        <option value="collection" <?php echo e($repair->delivery_type === 'collection' ? 'selected' : ''); ?>>
                            🏪 Collection
                        </option>
                        <option value="delivery" <?php echo e($repair->delivery_type === 'delivery' ? 'selected' : ''); ?>>
                            🚚 Delivery
                        </option>
                    </select>
                </div>
                ...
                <input type="hidden" name="discount" id="repair-discount-hidden"
                       value="<?php echo e($repair->discount); ?>">
                ...
                <div class="sm:col-span-2 lg:col-span-3">
                    ...
                    <textarea name="notes" rows="3" placeholder="Internal notes..."
                              class="repair-input"><?php echo e($repair->notes); ?></textarea>
                </div>
...
<?php $component->withAttributes(['title' => 'Devices','color' => 'green']); ?>
             ...
             <?php $__env->slot('badgeSlot', null, []); ?> 
                <span id="deviceCount"
                    ...
                    <?php echo e($repair->devices->count()); ?> devices
                </span>
             <?php $__env->endSlot(); ?>
            ...
            <div id="devicesContainer" class="space-y-4 mb-4">
                <div id="devicesEmpty"
                     ...
                     style="<?php echo e($repair->devices->count() > 0 ? 'display:none;' : ''); ?>">
...
const _EXISTING_DEVICES = <?php echo json_encode($existingDevicesData, 15, 512) ?>;
...
function _initEditForm() {
    ...
    setTimeout(() => {
        document.dispatchEvent(new CustomEvent('customer-created', {
            detail: {
                id   : <?php echo e($repair->customer->id); ?>,
                name : <?php echo json_encode($repair->customer->name, 15, 512) ?>,
                phone: <?php echo json_encode($repair->customer->phone ?? '', 15, 512) ?>,
                email: <?php echo json_encode($repair->customer->email ?? '', 15, 512) ?>,
            }
        }));
    }, 100);
    <?php endif; ?>
    ...
    // ── 3. Discount ────────────────────────────────────────────
    <?php if((float)$repair->discount > 0): ?>
    setTimeout(() => {
        if (window.RepairPayments?.setDiscountFromEdit) {
            RepairPayments.setDiscountFromEdit(<?php echo e((float)$repair->discount); ?>);
        }
    }, 200);
    <?php endif; ?>
}
...
<?php endif; ?><?php /**PATH C:\Users\Your Tech Point\Desktop\Shop\phonesho_sas\resources\views/repairs/edit.blade.php ENDPATH**/ ?>