...
<form id="product-form"
      method="POST"
      action="<?php echo e($isEdit ? route('products.update', $product) : route('products.store')); ?>">
    <?php echo csrf_field(); ?>
    <?php if($isEdit): ?>
    ...
    <input type="hidden"
           id="product-id-input"
           name="product_id"
           value="<?php echo e($isEdit ? $product->id : ''); ?>">
                        ...
                        <div>
                            <h3 id="product-form-title"
                                class="text-sm font-bold text-gray-900
                                        dark:text-white">
                                <?php echo e($isEdit ? 'Edit Product' : 'New Product'); ?>
                            ...
                            <span id="product-form-badge"
                                  ...
                                  style="<?php echo e(!$isEdit ? '' : ''); ?>">
                                <?php echo e($isEdit ? 'Editing existing' : 'Creating new'); ?>
                    ...
                    <div>
                        ...
                        <textarea id="field-description"
                                  ...
                                  class="w-full px-3.5 py-2.5 resize-none
                                         ...
                                         placeholder-gray-400
                                         focus:border-indigo-500
                                         transition-all"><?php echo e(old('description', $product?->description)); ?></textarea>
                    </div>
                ...
                <div class="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number"
                               ...
                               value="<?php echo e(old('low_stock_alert', $product?->low_stock_alert ?? 5)); ?>"
                               min="0"
                               class="w-full px-3.5 py-2.5
                                      border border-gray-200 dark:border-gray-700
                                      rounded-xl text-sm outline-none
...
</form><?php /**PATH C:\Users\Your Tech Point\Desktop\Shop\phonesho_sas\resources\views/products/partials/form.blade.php ENDPATH**/ ?>