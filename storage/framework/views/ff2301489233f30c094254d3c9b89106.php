...
<?php $component->withAttributes([]); ?>
 <?php $__env->slot('title', null, []); ?> <?php echo e($repair->reference); ?> <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => ''.e($repair->reference).'','subtitle' => 'Repair Detail','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($repair->reference).'','subtitle' => 'Repair Detail','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Dashboard', 'route' => 'dashboard'],
        ['label' => 'Repairs',   'route' => 'repairs.index'],
        ['label' => $repair->reference],
    ])]); ?>
     <?php $__env->slot('actions', null, []); ?> 
        ...
        <form method="POST" action="<?php echo e(route('repairs.destroy', $repair)); ?>"
              onsubmit="return confirm('Delete <?php echo e($repair->reference); ?>? This cannot be undone.')">
        ...
        <div class="bg-white dark:bg-gray-900 border border-gray-200
            ...
            <div class="p-5 flex items-center gap-4">
                <div class="w-11 h-11 rounded-full bg-indigo-600 flex items-center
                    ...
                    <?php echo e(strtoupper(substr($repair->customer->name, 0, 1))); ?>
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                        <?php echo e(implode(' · ', array_filter([$repair->customer->phone, $repair->customer->email])) ?: '—'); ?>

                    </p>
                    <?php if($repair->customer->address): ?>
                    <p class="text-xs text-gray-400 mt-0.5"><?php echo e($repair->customer->address); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <?php else: ?>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-3 px-1">
                ...
                <span class="text-xs font-bold px-2 py-0.5 rounded-full
                    ...
                    <?php echo e($repair->devices->count()); ?>
            ...
            <div class="bg-white dark:bg-gray-900 border border-gray-200
                ...
                <div class="flex items-center justify-between px-5 py-3.5
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs text-gray-400"><?php echo e($device->deviceType->name); ?></span>
                        <?php endif; ?>
                        <?php if($device->color): ?>
                        <span class="text-xs text-gray-400">· <?php echo e($device->color); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button type="button" @click="open = !open"
                                    id="dev-status-pill-<?php echo e($device->id); ?>"
                                    class="inline-flex items-center gap-1.5 px-2.5 py-1
                                           rounded-full text-xs font-semibold cursor-pointer
                                           border-none transition-all <?php echo e($dBadge); ?>">
                                <span class="w-1.5 h-1.5 rounded-full bg-current opacity-70"></span>
                                <span id="dev-status-label-<?php echo e($device->id); ?>">
                                    <?php echo e($device->status?->name ?? 'No Status'); ?>
                            ...
                            <div x-show="open" @click.outside="open = false" x-transition
                                 ...
                                 style="display:none;">
                                <?php $__currentLoopData = $deviceStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $sb = $statusColors[$s->color ?? 'gray'] ?? 'badge-gray'; ?>
                                <button type="button"
                                        onclick="updateDeviceStatus(<?php echo e($device->id); ?>, <?php echo e($s->id); ?>, '<?php echo e($s->name); ?>', '<?php echo e($s->color); ?>')"
                                        @click="open = false"
                                        class="w-full flex items-center gap-2 px-3 py-2 text-left
                                               hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                    <span class="inline-flex items-center gap-1.5 px-2 py-0.5
                                                 rounded-full text-xs font-semibold <?php echo e($sb); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full bg-current opacity-70"></span>
                                        <?php echo e($s->name); ?>
                ...
                <div class="px-5 py-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($device->issue); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($device->repair_type); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-1.5">
                            ...
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs
                                ...
                                <span class="ml-1 opacity-60">×<?php echo e($part->quantity); ?></span>
                                <?php endif; ?>
                            </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-2.5 py-1 rounded-full
                                     text-xs font-bold <?php echo e($wBadge); ?>">
                            <?php echo e($wLabel); ?>
        ...
        <div class="bg-white dark:bg-gray-900 border border-gray-200
            ...
            <div class="p-5 grid grid-cols-2 sm:grid-cols-4 gap-5">
                ...
                <div>
                    ...
                    <p class="text-sm font-bold text-gray-900 dark:text-white">
                        <?php echo e($repair->delivery_type === 'delivery' ? '🚚' : '🏪'); ?>
        ...
        <div class="lg:sticky lg:top-5 space-y-4">
                ...
                <div class="p-5 space-y-2.5">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span id="show-paid" class="font-semibold text-emerald-600 dark:text-emerald-400">
                            £<?php echo e(number_format($summary['total_paid'], 2)); ?>

                        </span>
                    </div>
                    <div id="show-outstanding-row"
                         class="<?php echo e($summary['outstanding'] > 0 ? '' : 'hidden'); ?>">
                        <div class="flex justify-between text-sm font-bold
                            ...
                            <span id="show-outstanding" class="text-red-600 dark:text-red-400">
                                £<?php echo e(number_format($summary['outstanding'], 2)); ?>
            ...
            <div class="bg-white dark:bg-gray-900 border border-gray-200
                ...
                <div id="payments-list" class="divide-y divide-gray-100 dark:divide-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $repair->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between px-4 py-3"
                         id="payment-row-<?php echo e($payment->id); ?>">
                        <div>
                            <p class="text-sm font-semibold text-gray-700 dark:text-gray-300 capitalize">
                                <?php echo e($payment->method === 'split' && $payment->split_part
                                    ? ucfirst($payment->split_part) . ' (split)'
                                    : ucfirst($payment->method)); ?>

                            </p>
                            <?php if($payment->note): ?>
                            <p class="text-xs text-gray-400"><?php echo e($payment->note); ?></p>
                            <?php endif; ?>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <button type="button" onclick="deletePayment(<?php echo e($payment->id); ?>)"
        ...
        <div class="px-6 py-5 space-y-5">
            ...
            <div>
                ...
                <div class="grid grid-cols-4 gap-2">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="cursor-pointer">
                        <input type="radio" name="show_payment_method" value="<?php echo e($val); ?>"
                               class="sr-only peer"
                               onchange="onPayMethodChange('<?php echo e($val); ?>')"
                               <?php echo e($val === 'cash' ? 'checked' : ''); ?>>
                        <div class="flex flex-col items-center gap-1.5 py-3 rounded-xl border-2
                            ...
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      stroke-width="1.8" d="<?php echo e($m['icon']); ?>"/>
                            </svg>
                            <span class="text-xs font-bold"><?php echo e($m['label']); ?></span>
                        </div>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div id="show-fields-cash">
                ...
                <div class="grid grid-cols-5 gap-1.5 mb-2">
                    <?php $__currentLoopData = [5,10,20,50]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" onclick="setShowQuickAmount(<?php echo e($amt); ?>)"
...
const _PAYMENT_URL    = '<?php echo e(route("repairs.add-payment",    $repair)); ?>';
const _DEL_PAY_URL    = '/repairs/<?php echo e($repair->id); ?>/payment/{id}';
const _DEV_STATUS_URL = '/repairs/<?php echo e($repair->id); ?>/device/{device}/status';

let _outstanding = <?php echo e($summary['outstanding']); ?>;
...
<?php endif; ?><?php /**PATH C:\Users\Your Tech Point\Desktop\Shop\phonesho_sas\resources\views/repairs/show.blade.php ENDPATH**/ ?>