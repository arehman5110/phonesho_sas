...
<div>
    ...
    <div class="grid grid-cols-4 gap-2">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <label class="cursor-pointer">
            <input type="radio"
                   name="repair_payment_method"
                   value="<?php echo e($value); ?>"
                   class="sr-only peer"
                   onchange="RepairPayments.onMethodChange('<?php echo e($value); ?>')"
                   <?php echo e($value === 'cash' ? 'checked' : ''); ?>>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="repair-fields-cash">
                ...
                <div class="grid grid-cols-5 gap-1.5 mb-2">
                    ...
                    <button type="button"
                            onclick="RepairPayments.setQuickAmount(<?php echo e($amt); ?>)"
...
</div><?php /**PATH C:\Users\Your Tech Point\Desktop\Shop\phonesho_sas\resources\views/repairs/partials/modals/payment.blade.php ENDPATH**/ ?>